...
OUTPUT_DIR="${OUTPUT_DIR:-w3_5pane_results_trungnt/default}"
...
run_for_host() {
  ...
  cmd=(
    "$PYTHON_BIN" w3_5pane_benchmark.py
      ...
      --tmux-search-window "$TMUX_SEARCH_WINDOW"
