...
BACKGROUND_OPEN_RETRIES="${BACKGROUND_OPEN_RETRIES:-3}"
BACKGROUND_OPEN_BACKOFF_MS="${BACKGROUND_OPEN_BACKOFF_MS:-1000}"
BACKGROUND_OPEN_GAP_SEC="${BACKGROUND_OPEN_GAP_SEC:-0.5}"
PROTOCOL_COOLDOWN_SEC="${PROTOCOL_COOLDOWN_SEC:-2.0}"
...
run_for_host() {
  ...
  cmd=(
    "$PYTHON_BIN" w3_5pane_benchmark.py
      ...
      --background-open-retries "$BACKGROUND_OPEN_RETRIES"
      --background-open-backoff-ms "$BACKGROUND_OPEN_BACKOFF_MS"
      --background-open-gap-sec "$BACKGROUND_OPEN_GAP_SEC"
      --protocol-cooldown-sec "$PROTOCOL_COOLDOWN_SEC"
  )
