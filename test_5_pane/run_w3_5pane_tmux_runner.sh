...
# Canonical W3 5-pane workload:
#   1 remote tmux session, pane 0 for interactive measurement,
#   panes 1-4 for visible background load.
# For protocol/channel experiments, use run_w3_protocol_multiplex_runner.sh.
