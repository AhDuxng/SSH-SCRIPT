...
TRANSFER_FIELDS = IDENTITY_FIELDS + (
    ...
    "last_byte_time_ns", "marker_time_ns", "content_complete_time_ns",
    "first_byte_latency_ms", "completion_latency_ms", "marker_latency_ms",
    "content_complete_latency_ms", "content_complete", "exit_code",
...
STREAM_FIELDS = IDENTITY_FIELDS + (
    ...
    "content_complete_transfers", "content_complete_rate_pct",
    "output_completeness_pct", "fully_verified_output_rate_pct",
    "attempted_fully_verified_output_rate_pct",
    "expected_output_bytes", "verified_output_bytes",
    "verified_output_ratio_pct", "attempted_expected_output_bytes",
    "attempted_verified_output_bytes", "attempted_verified_output_ratio_pct",
