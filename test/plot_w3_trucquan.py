...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--results-dir",
        default=str(project_root / "test_5_pane" / "w3_5pane_results"),
        help="Root directory containing CSV results (flat or with profile subfolders).",
    )
    parser.add_argument(
        "--csv-name",
