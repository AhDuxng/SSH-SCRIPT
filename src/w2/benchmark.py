...
class Benchmark:
                ...
                if "screen_update_latency" in self.args.metrics:
                    ...
                    for i in range(1, total_iterations + 1):
                        ...
                        try:
                            ...
                            self._record_fail(protocol, "screen_update_latency", trial_id, sid, is_warmup, exc, child)
    ...
    def _metric_budget(self, protocol: str, metric: str) -> int:
        if protocol in self.protocol_skip_reasons:
            return 0
        if metric in {"line_echo", "keystroke_latency", "screen_update_latency"}:
