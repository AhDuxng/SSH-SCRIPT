...
class ProtocolRunner:
    ...
    # Mở session, đo đến prompt đầu tiên rồi cài prompt riêng phục vụ gating.
    def open(self):
        ...
        try:
            ...
            # Tắt echo trước để marker không thể bị match từ input gửi đi.
            child.sendline("stty -echo")
            child.expect(INITIAL_PROMPT_RE, timeout=timeout)
            child.sendline(
                f"export PS1={shlex.quote(self.prompt_marker)}; export COLUMNS=200"
            )
